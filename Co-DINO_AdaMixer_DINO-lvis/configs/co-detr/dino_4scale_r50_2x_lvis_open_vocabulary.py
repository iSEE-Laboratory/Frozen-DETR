...
class_embedding_path = 'lvis_manual_category_embeddings_ViT-L-14-336px.pt'
...
model = dict(
    ...
    query_head=dict(
        ...
        positional_encoding=dict(
            ...
            normalize=True),
        loss_cls=dict(
            type='FederatedQualityFocalLoss',
            use_sigmoid=True,
            beta=2.0,
            loss_weight=1.0,
            open_vocabulary=open_vocabulary,
            base_ind_file='../pretrained_models/lvis_base_inds.txt'),
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type=dataset_type,
            ann_file=data_root + 'annotations/lvis_v1_train_seen.json',
