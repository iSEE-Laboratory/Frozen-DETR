...
model = dict(
    type='QueryBased',
    pretrained='../torchvision_resnet50.pth',
    backbone=dict(
        type='ResNet',
        depth=50,
        num_stages=4,
    ...
    roi_head=dict(
        ...
        # foundation_model_type='eva_clip',
        # foundation_model_path='../pretrained_models/EVA02_CLIP_L_336_psz14_s6B.pt',
        # foundation_model_type='dinov2',
        # foundation_model_path='../pretrained_models/dinov2_vitl14_pretrain.pth',
        # foundation_model_type='deit',
        # foundation_model_path='../pretrained_models/deit_3_large_384_21k.pth',
        # foundation_model_type='mae',
        # foundation_model_path='../pretrained_models/mae_pretrain_vit_large.pth',
        # foundation_model_type='beit',
        # foundation_model_path='../pretrained_models/beit3_large_indomain_patch16_224.pth',
        num_global_token=5,
        bbox_head=[
            dict(
