...
class vit_models(nn.Module):
    ...
    def forward(self, x):
        ...
        return x[:, 0], x[:, 1:].reshape(B, num_patch, num_patch, self.embed_dim)



# DeiT III: Revenge of the ViT (https://arxiv.org/abs/2204.07118)

def deit_base_patch16_LS(pretrained=False, img_size=224, pretrained_21k = False, model_path=None,  **kwargs):
    model = vit_models(
...
def deit_large_patch16_LS(pretrained=False, img_size=224, pretrained_21k = False, model_path=None,  **kwargs):
    model = vit_models(
...
def deit_huge_patch14_LS(pretrained=False, img_size=224, pretrained_21k = False, model_path=None,  **kwargs):
    model = vit_models(
